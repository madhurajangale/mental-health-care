...
app.get('/exercise', (req, res) => {
    res.render('exercise'); // Make sure exercise.ejs is in the "views" folder
});

app.get('/exercisecopy', (req, res) => {
    res.render('exercise copy'); // Make sure exercise.ejs is in the "views" folder
});
